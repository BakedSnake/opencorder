...
Texture2D REEL;
Texture2D LOWPASS_BTN_TEX;
Texture2D LOWPASS_BTN_TEX_PRESSED;
Texture2D MIDPASS_BTN_TEX;
Texture2D MIDPASS_BTN_TEX_PRESSED;
Texture2D HIHPASS_BTN_TEX;
Texture2D HIHPASS_BTN_TEX_PRESSED;
float ROTATION                   = 0.;
